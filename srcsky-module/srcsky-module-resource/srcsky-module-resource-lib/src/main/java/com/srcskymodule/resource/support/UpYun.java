...
public class UpYun {
    private final static Logger logger = Logger.getLogger(UpYun.class);
    ...
    public boolean writeFile(String file, File _file, Boolean auto) throws Exception {
        ...
        try {
            ...
            logger.info("上传文件到又拍云完成：" + file + ",耗时" + (System.currentTimeMillis() - timer) + "MS");
            return true;
        } catch (IOException ex) {
            logger.error("又拍云API操作异常", ex);
            return false;
    ...
    public static void main(String[] args) throws Exception {
        ...
        UpYun upYun = new UpYun("meilepai-img", "z82422", "xiaojiang");
        upYun.setFileSecret("f7629a9004108ba475dbfd3850d6eb52");
        //upYun.writeFile("/test2.jpg", file, true);
        System.out.println(upYun.writeFile("/test.jpg", org.apache.commons.io.IOUtils.toByteArray(new FileInputStream(file)), true));
        //upYun.writeFile("/xj.jpg", org.apache.commons.io.IOUtils.toByteArray(new FileInputStream(file)), true);
