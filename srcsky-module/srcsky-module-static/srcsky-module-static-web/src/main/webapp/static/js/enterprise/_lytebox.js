 ...
 **/
KISSY.add("enterprise/_lytebox", function (S, DOM) {
...
//**************************************************************************************************/
        function Lytebox(bInitialize, aHttp) {
            ...
            var label = this.label = new Object();
            label['close'] = 'Close (Esc)';
            label['prev'] = 'Previous (\u2190)';	// Previous (left arrow)
            label['next'] = 'Next (\u2192)'; 		// Next (right arrow)
            label['play'] = 'Play (spacebar)';
            label['pause'] = 'Pause (spacebar)';
            label['print'] = 'Print';
            label['image'] = 'Image %1 of %2';		// %1 = active image, %2 = total images
            label['page'] = 'Page %1 of %2'; 		// %1 = active page, %2 = total pages
        ...
        Lytebox.prototype.setBrowserInfo = function () {
            ...
            this.chrome = S.UA.shell == "chrome";//ua.indexOf('chrome') > -1;
            this.ff = S.UA.shell == "firefox";//ua.indexOf('firefox') > -1;
            this.safari = S.UA.shell == "safari";//!this.chrome && ua.indexOf('safari') > -1;
            this.opera = S.UA.shell == "opera";//ua.indexOf('opera') > -1;
            this.ie = S.UA.shell == "ie";
            if (this.chrome) {
                this.chromeVersion = S.UA.chrome;
            }
            if (this.ff) {
                this.ffVersion = S.UA.shell.firefox;
            }
            if (this.ie) {
                this.ieVersion = S.UA.shell.ie;
            }
            if (this.opera) {
                this.operaVersion = S.UA.shell.opera;
            }
            if (this.safari) {
                this.safariVersion = S.UA.shell.safari;
            }
        };
        ...
        Lytebox.prototype.initialize = function () {
            ...
            DOM.append(DOM.create("<a/>", { id:"lbLauncher", "class":"lytebox", css:{display:"none"} }), oBody);
            DOM.append(DOM.create("<div/>", { id:"lbOverlay", "class":this.theme, css:{ position:(this.ie && (this.ieVersion <= 6 || (this.ieVersion <= 9 && this.doc.compatMode == 'BackCompat'))) ? "absolute" : "", display:"none"} }), oBody);

            var oLytebox = DOM.create("<div/>", {id:"lbMain", css:{display:"none"}});
            DOM.append(oLytebox, oBody);

            var oOuterContainer = DOM.create("<div/>", {id:"lbOuterContainer", "class":this.theme});
            if (this.roundedBorder) {
                oOuterContainer.style.MozBorderRadius = '8px';
                oOuterContainer.style.borderRadius = '8px';
            }
            DOM.append(oOuterContainer, oLytebox);

            var oTopContainer = DOM.create("<div/>", {id:"lbTopContainer", "class":this.theme});
            if (this.roundedBorder) {
            ...
            var oTopData = DOM.create("<div/>", {id:"lbTopData", "class":this.theme});
            oTopContainer.appendChild(oTopData);

            DOM.append(DOM.create("<span/>", {id:"lbTitleTop"}), oTopData);
            DOM.append(DOM.create("<span/>", {id:"lbNumTop"}), oTopData);

            var oTopNav = DOM.create("<div/>", {id:"lbTopNav"});
            oTopContainer.appendChild(oTopNav);

            DOM.append(DOM.create("<a/>", {id:"lbCloseTop", title:label['close'], "class":this.theme, 'href':'javascript:void(0)'}), oTopNav);
            DOM.append(DOM.create("<a/>", {id:"lbPrintTop", title:label['print'], "class":this.theme, 'href':'javascript:void(0)'}), oTopNav);
            DOM.append(DOM.create("<a/>", {id:"lbNextTop", title:label['next'], "class":this.theme, 'href':'javascript:void(0)'}), oTopNav);

            DOM.append(DOM.create("<a/>", {id:"lbPauseTop", title:label['pause'], "class":this.theme, 'href':'javascript:void(0)', css:{display:"none"}}), oTopNav);
            DOM.append(DOM.create("<a/>", {id:"lbPlayTop", title:label['play'], "class":this.theme, 'href':'javascript:void(0)', css:{display:"none"}}), oTopNav);

            DOM.append(DOM.create("<a/>", {id:"lbPrevTop", title:label['prev'], "class":this.theme, 'href':'javascript:void(0)'}), oTopNav);

            var oIframeContainer = DOM.create('<div/>', {id:"lbIframeContainer", css:{display:"none"}});
            oOuterContainer.appendChild(oIframeContainer);

            var oIframe = DOM.create('<iframe/>', {id:"lbIframe", name:"lbIframe", frameBorder:0, css:{display:"none"}});
            if (this.innerBorder) {
                oIframe.setAttribute(this.classAttribute, this.theme);
            }
            oIframeContainer.appendChild(oIframe);

            var oImageContainer = DOM.create('<div/>', {id:"lbImageContainer"});
            oOuterContainer.appendChild(oImageContainer);
            var oLyteboxImage = DOM.create('<img/>', {id:'lbImage'});
            if (this.innerBorder) {
                oLyteboxImage.setAttribute(this.classAttribute, this.theme);
            }
            oImageContainer.appendChild(oLyteboxImage);
            var oLoading = DOM.create('<div/>', {'id':'lbLoading', "class":this.theme});
            oOuterContainer.appendChild(oLoading);
            var oBottomContainer = DOM.create('<div/>');
            ...
            DOM.append(oBottomContainer, oOuterContainer);

            var oDetailsBottom = DOM.create('<div/>', {id:"lbBottomData", "class":this.theme});
            DOM.append(oDetailsBottom, oBottomContainer);

            var oTitleBottom = DOM.create('<span/>', {id:"lbTitleBottom"});
            oDetailsBottom.appendChild(oTitleBottom);
            var oNumBottom = DOM.create('<span/>', {id:"lbNumBottom"});
            oDetailsBottom.appendChild(oNumBottom);
            var oDescBottom = DOM.create('<span/>', {id:"lbDescBottom"});
            oDetailsBottom.appendChild(oDescBottom);
            var oHoverNav = DOM.create('<div/>', {id:"lbHoverNav"});
            oImageContainer.appendChild(oHoverNav);
            var oBottomNav = DOM.create('<div/>', {id:"lbBottomNav"});
            oBottomContainer.appendChild(oBottomNav);
            var oPrevHov = DOM.create('<a/>', {id:"lbPrevHov", title:label['prev'], "class":this.theme, 'href':'javascript:void(0)'});
            oHoverNav.appendChild(oPrevHov);
            var oNextHov = DOM.create('<a/>', {id:"lbNextHov", "class":this.theme, title:label['next'], 'href':'javascript:void(0)'});
            oHoverNav.appendChild(oNextHov);
            var oClose = DOM.create('<a/>', {id:"lbClose", "class":this.theme, title:label['close'], 'href':'javascript:void(0)'});
            oBottomNav.appendChild(oClose);
            var oPrint = DOM.create('<a/>', {id:"lbPrint", "class":this.theme, title:label['print'], 'href':'javascript:void(0)', css:{display:"none"}});
            oBottomNav.appendChild(oPrint);
            var oNext = DOM.create('<a/>', {id:"lbNext", "class":this.theme, title:label['next'], 'href':'javascript:void(0)'});
            oBottomNav.appendChild(oNext);
            var oPause = DOM.create('<a/>', {id:"lbPause", 'title':label['pause'], "class":this.theme, 'href':'javascript:void(0)', css:{display:"none"}});
            oBottomNav.appendChild(oPause);
            var oPlay = DOM.create('<a/>', {id:"lbPlay", 'title':label['play'], "class":this.theme, css:{display:"none"}, 'href':'javascript:void(0)'});
            oBottomNav.appendChild(oPlay);
            var oPrev = DOM.create('<a/>', {id:"lbPrev", 'title':label['prev'], "class":this.theme, 'href':'javascript:void(0)'});
        ...
        Lytebox.prototype.updateLyteboxItems = function () {
            ...
            for (var i = 0; i < lyteLinks.length; i++) {
                ...
                if (myLink.getAttribute('href')) {
                    sType = classAttribute.match(/lytebox|lyteimg|lyteshow|lyteframe/i);
                    sType = this.isEmpty(sType) ? relAttribute.match(/lytebox|lyteimg|lyteshow|lyteframe/i) : sType;
                    dataOptions = String(myLink.getAttribute('data-lyte-options'));
                    dataOptions = this.isEmpty(dataOptions) ? String(myLink.getAttribute('rev')) : dataOptions;
                    aUrl = myLink.getAttribute('href').split('?');
                    sExt = aUrl[0].split('.').pop().toLowerCase();
                    bImage = (sExt == 'png' || sExt == 'jpg' || sExt == 'jpeg' || sExt == 'gif' || sExt == 'bmp' || classAttribute.match(/lyteimg/i));
                    ...
                    if (classAttribute.toLowerCase().match('lytetip') && !this.isEmpty(dataTip) && !this.tipsSet) {
                        ...
                        if (!this.isEmpty(dataOptions)) {
                            ...
                            for (var j = 0; j < aOptions.length; j++) {
                                ...
                                sName = (aSetting.length > 1 ? S.trim(aSetting[0]).toLowerCase() : '');
                                sValue = (aSetting.length > 1 ? S.trim(aSetting[1]) : '');
                                switch (sName) {
                                    case 'tipstyle':
            ...
            if (this.isEmpty(this.group)) {
                ...
                for (var i = 0; i < lyteLinks.length; i++) {
                    ...
                    if (myLink.getAttribute('href') && dataOptions.toLowerCase().match('group:' + this.group)) {
                        sType = String(myLink.getAttribute(this.classAttribute)).match(/lytebox|lyteimg|lyteshow|lyteframe/i);
                        sType = this.isEmpty(sType) ? myLink.getAttribute('rel').match(/lytebox|lyteimg|lyteshow|lyteframe/i) : sType;
                        aUrl = myLink.getAttribute('href').split('?');
                        sExt = aUrl[0].split('.').pop().toLowerCase();
        ...
        Lytebox.prototype.changeContent = function (iContentNum) {
            ...
            if (this.isLyteframe) {
                ...
                var w = S.trim(this.width);
                var h = S.trim(this.height);
                if (/\%/.test(w)) {
        ...
        Lytebox.prototype.resizeContainer = function (iWidth, iHeight) {
            ...
            if (!(hDiff == 0)) {
                this.hDone = false;
                this.resizeH('lbOuterContainer', this.hCur, this.resizeHeight + this.borderSize * 2, this.getPixelRate(this.hCur, this.resizeHeight),0);
            } else {
                this.hDone = true;
                if (!this.wDone) {
                    this.resizeW('lbOuterContainer', this.wCur, this.resizeWidth + this.borderSize * 2, this.getPixelRate(this.wCur, this.resizeWidth),0);
                }
            }
            if ((hDiff == 0) && (wDiff == 0)) {
                if (this.ie) {
        ...
        Lytebox.prototype.showContent = function () {
            if (this.isSlideshow) {
                ...
                this.doc.$('lbClose').style.display = (this.showClose ? '' : 'none');
        ...
        Lytebox.prototype.isEmpty = function (args) {
            ...
            return (S.trim(sValue) == '' || sValue == 'null' || sValue == null || typeof(sValue) == 'undefined');
        };

        return S.Lytebox = {
            update:function () {
                window.$lb = new Lytebox(true);
            }
        };

    }, {requires:"dom,enterprise/css/_lytebox.css".split(",")}
