...
KISSY.add('gallery/starrating/1.0/starrating', function (S, Base, undefined) {
    var DOT = '.', EMPTY = '';
            ...
            container.all(DOT + self.get('itemCls')).each(function (item, i) {
                ...
                item.all('a').each(function (a, j) {
                    ...
                    a.on('click',function (ev) {
                        ...
                        item.one(DOT + self.get('resultCls')).html('<span style="padding-left: 20px;"><em>' + sc + '</em> 星</span> - <strong>' + rs + '</strong>');
                        ...
                        if (!ev._continue) {
                            ...
                            container.all(DOT + self.get('popCls'))
                                .html('<span><em>' + sc + '</em> 星 ' + level[j] + '</span><strong>' + rs + '</strong>')
                                .css({
